	...
	return (
		<Wrapper>
			<div className={classes.texts}>
				...
				<p>
					Apart from writing custom code from scratch, I am also experienced in
					working with popular CMS platforms like WordPress or PrestaShop. I can
					also build personal branding tools such as e-business cards, websites,
					and resumes.
				</p>
